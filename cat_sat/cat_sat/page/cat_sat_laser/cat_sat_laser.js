frappe.pages['cat-sat-laser'].on_page_load = function (wrapper) {
    var page = frappe.ui.make_app_page({
        parent: wrapper,
        title: 'Laser Cutting Optimization',
        single_column: true
    });

    $(frappe.render_template('cat_sat_laser')).appendTo(page.body);
...
cat_sat_laser = {
    ...
    run_optimization: function () {
        ...
        frappe.call({
            method: 'cat_sat.api.portal_api.run_laser_optimization',
